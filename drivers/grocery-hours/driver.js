...
const { pairedGroceryDeviceTitle } = require('../../lib/grocery/pairing-display');

module.exports = class GroceryHoursDriver extends Homey.Driver {

  async onInit() {
    this.log('GroceryHoursDriver initialized');
  }
  ...
  async onPair(session) {
    ...
    session.setHandler('list_devices', async () => {
      ...
      const deviceTitle = pairedGroceryDeviceTitle(chainId, chainLabel, loaded.name);
      return [
        {
          name: deviceTitle,
          data: { id },
          settings: {
            ...
            grocery_store_numeric_id: numeric,
